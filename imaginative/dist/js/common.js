...
$(document).ready(function() {
	...
	var section3NameInput = document.querySelector('.section3__name-input');
	var section3EmailInput = document.querySelector('.section3__email-input');
	var section3MessageInput = document.querySelector('.section3__message-input');
	var section3SubmitButton = document.querySelector('.section3__submit-button');
	var validationArr = [section3NameInput, section3EmailInput, section3MessageInput];

	section3SubmitButton.addEventListener('click', validationCheck);
	...
	function validationCheck() {
		for (var i = 0; i < validationArr.length; i++) {
			if (!validationArr[i].value) {
				validationArr[i].style.borderColor = '#97455F';
				modalErrorShow();
			} else {
		...
		if (section3NameInput.value && section3EmailInput.value && section3MessageInput.value) {
			modalSuccessShow();
		}
	}
