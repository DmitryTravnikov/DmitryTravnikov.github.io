...
$(document).ready(function() {
    ...
    $('.fish3').css('top',((10+(ypos/50))+"%"));//вписать позицию элемента, для которого задается параллакс
    $('.man').css('right',((0+(xpos/80))+"px"));//вписать позицию элемента, для которого задается параллакс
