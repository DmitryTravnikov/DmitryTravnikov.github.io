...
function jsBundling(done) {
	return gulp.src('app/base/common.js')
...
function sassCompile() {
	return gulp.src('app/base/main.scss')
...
function watch() {
	...
	gulp.watch('app/**/*.+(scss|sass)', sassCompile);
	gulp.watch('app/**/*.pug', pugCompile);
	gulp.watch('app/*.html').on('change', browserSync.reload);
	gulp.watch(['app/base/**/*.js', 'app/components/**/*.js']).on('change', browserSync.reload);
