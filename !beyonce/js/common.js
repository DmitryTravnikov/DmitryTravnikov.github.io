...
$(document).ready(function() {
	...
	window.onscroll = function() {
	  if ($(window).width() > 960) {
	    ...
	    var parallax4 = document.querySelectorAll('.parallax4');

	    for (var i = 0; i < parallax1.length; i++) {
	      parallax1[i].style.top = 49 + ypos * -0.08 + 'rem';
	    }
	    for (var i = 0; i < parallax2.length; i++) {
	      parallax2[i].style.bottom = -46 + ypos * 0.15 + 'rem';	
	    }
	    for (var i = 0; i < parallax3.length; i++) {
	      parallax3[i].style.bottom = -16 + ypos * 0.06 + 'rem';	
	    }
	    for (var i = 0; i < parallax4.length; i++) {
	    	parallax4[i].style.opacity = '1';
	    }
	    ...
	    if (ypos === 280) {
	    	...
	    	for (var i = 0;  i < parallax3.length; i++) {
	    		parallax3[i].classList.remove('parallax3');
	    	}
	    	for (var i = 0;  i < parallax4.length; i++) {
	    		parallax4[i].classList.remove('parallax4');
	    	}
	    }
